...
interface ToolkitOrderanKilat50kProps {
    showToast?: (message: string) => void;
}

const ToolkitOrderanKilat50k: React.FC<ToolkitOrderanKilat50kProps> = ({ showToast }) => {
    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_CONFIG.BASE_URL}/toolkit/orderan-kilat-50k`, formData, {
                responseType: 'blob',
            });
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4">
            <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-start">
                <div>
                    <h3 className="text-lg font-bold text-gray-900">Orderan Kilat (Filter SKU VIP &gt;50K)</h3>
                    <p className="text-sm text-gray-500 mt-1">Upload Excel Ginee, lalu sistem akan memfilter dan menyisakan data resi yang mengandung MSKU dari daftar SKU VIP (&gt;50K).</p>
                </div>
            </div>
            ...
            <div className="p-6 space-y-6">
                ...
                {downloadUrl && (
                    <div className="bg-green-50 border border-green-200 text-green-700 p-4 rounded-lg flex items-center justify-between">
                        ...
                        <a 
                            href={downloadUrl}
                            download="Hasil_Orderan_Kilat_50K.xlsx"
...
export default ToolkitOrderanKilat50k;
