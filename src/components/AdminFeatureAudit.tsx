...
const FEATURE_REGISTRY: FeatureItem[] = [
    ...
    { id: 'tk-orderan-kilat-10k', category: 'toolkit', categoryLabel: 'Toolkit Operasional', name: '11. Orderan Kilat (VIP >10K)', description: 'Filter file Excel Ginee, khusus pesanan VIP >10K (Admin Toggleable).', component: 'ToolkitOrderanKilat10k.tsx', status: 'vip', statusLabel: 'VIP FEATURE' },
    { id: 'tk-orderan-kilat-20k', category: 'toolkit', categoryLabel: 'Toolkit Operasional', name: '12. Orderan Kilat (VIP >20K)', description: 'Filter file Excel Ginee, khusus pesanan VIP >20K (Admin Toggleable).', component: 'ToolkitOrderanKilat20k.tsx', status: 'vip', statusLabel: 'VIP FEATURE' },
    { id: 'tk-orderan-kilat-50k', category: 'toolkit', categoryLabel: 'Toolkit Operasional', name: '13. Orderan Kilat (VIP >50K)', description: 'Filter file Excel Ginee, khusus pesanan VIP >50K (Admin Toggleable).', component: 'ToolkitOrderanKilat50k.tsx', status: 'vip', statusLabel: 'VIP FEATURE' },
    { id: 'tk-pdf-merger', category: 'toolkit', categoryLabel: 'Toolkit Operasional', name: '14. Gabung Label Asli (PDF Merger)', description: 'Gabungkan 2+ file PDF resi asli menjadi satu file PDF utuh.', component: 'ToolkitPdfMerger.tsx', status: 'active', statusLabel: 'STABIL (100%)' },
    ...
    { id: 'admin-sku-vip-10k', category: 'admin', categoryLabel: 'Admin Control Center', name: 'SKU VIP (>10K)', description: 'Kelola list SKU bernilai tinggi VIP >10.000.', component: 'AdminSkuVip10k.tsx', status: 'vip', statusLabel: 'VIP FEATURE' },
    { id: 'admin-sku-vip-20k', category: 'admin', categoryLabel: 'Admin Control Center', name: 'SKU VIP (>20K)', description: 'Kelola list SKU bernilai tinggi VIP >20.000.', component: 'AdminSkuVip20k.tsx', status: 'vip', statusLabel: 'VIP FEATURE' },
    ...
    { id: 'admin-toolkit-access', category: 'admin', categoryLabel: 'Admin Control Center', name: 'Kontrol Akses Toolkit & Fitur VIP', description: 'PIN Lock & Toggle ON/OFF per alat (termasuk VIP >10K, >20K & >50K).', component: 'AdminToolkitFeatures.tsx', status: 'updated', statusLabel: 'UPDATE TERBARU' },
