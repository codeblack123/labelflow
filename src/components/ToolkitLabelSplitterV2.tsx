...
interface ToolkitLabelSplitterV2Props {
...
const ToolkitLabelSplitterV2: React.FC<ToolkitLabelSplitterV2Props> = ({ showToast }) => {
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-900">
                                Bagi Rata Label V.2 <span className="text-red-600 font-bold ml-1 text-xl">(SATUAN)</span>
                            </h2>
                            <p className="text-gray-500 text-sm">Pecah Excel per Batch. V.2: Bisa Prioritas Satuan (Pretelan Belakangan).</p>
                        </div>
                    </div>
                    {file && (
                        <button
                            onClick={() => {
                                ...
                                const input = document.getElementById('excel-upload-v2') as HTMLInputElement;
                ...
                <div className="space-y-6">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 hover:bg-gray-50 transition-colors text-center">
                        <input
                            ...
                            id="excel-upload-v2"
                        />
                        <label htmlFor="excel-upload-v2" className="cursor-pointer flex flex-col items-center gap-3">
                    ...
                    <div className="flex justify-end gap-3 flex-wrap">
                        ...
                        {!downloadUrl ? (
                            ...
                            <a
                                href={downloadUrl}
                                download={`splitted_batches_V2_${new Date().getTime()}.xlsx`}
...
export default ToolkitLabelSplitterV2;
